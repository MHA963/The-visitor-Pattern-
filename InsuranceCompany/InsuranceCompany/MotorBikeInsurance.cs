...
namespace InsuranceCompany
{
    public class MotorBikeInsurance : IInsurance
    {
        ...
        //public void MotorBike(string registrationumber, string postcode, string maker,
        ...
        //void print()
        //{
        //    Console.WriteLine("Motor Bike Insurance");
        ...
        {
            return "MotorBike Insurance, Wants SMS and Phone communication";
        }
    }
}
